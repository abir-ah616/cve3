        ...
        {activeTab === 'appearance' && (
          <div className="glass rounded-lg p-6">
            ...
            <div className="space-y-8">
              ...
              {/* Slot List Colors */}
              <div className="glass-lighter p-4 rounded-lg">
                <h3 className="text-lg font-orbitron mb-4">Slot List Colors</h3>
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <input
                      type="checkbox"
                      id="slotListGradient"
                      checked={tournamentInfo.slotListGradient}
                      onChange={(e) => updateTournamentInfo({ slotListGradient: e.target.checked })}
                      className="mr-2"
                    />
                    <label htmlFor="slotListGradient">Use gradient for "SLOT LIST" text</label>
                  </div>
                  
                  {tournamentInfo.slotListGradient ? (
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm mb-2">Gradient Start</label>
                        <input
                          type="color"
                          value={tournamentInfo.slotListGradientFrom}
                          onChange={(e) => updateTournamentInfo({ slotListGradientFrom: e.target.value })}
                          className="w-full h-10 rounded-md cursor-pointer"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          type="color"
                          value={tournamentInfo.slotListGradientTo}
                          onChange={(e) => updateTournamentInfo({ slotListGradientTo: e.target.value })}
                          className="w-full h-10 rounded-md cursor-pointer"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        type="color"
                        value={tournamentInfo.slotListColor}
                        onChange={(e) => updateTournamentInfo({ slotListColor: e.target.value })}
                        className="w-full h-10 rounded-md cursor-pointer"
                      />
                    </div>
                  )}
              ...
              {/* Slot Number Colors */}
              <div className="glass-lighter p-4 rounded-lg">
                <h3 className="text-lg font-orbitron mb-4">Slot Number Colors</h3>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm mb-2">Number Color</label>
                    <input
                      type="color"
                      value={tournamentInfo.slotNumberColor}
                      onChange={(e) => updateTournamentInfo({ slotNumberColor: e.target.value })}
                      className="w-full h-10 rounded-md cursor-pointer"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    <input
                      type="checkbox"
                      id="slotNumberGlow"
                      checked={tournamentInfo.slotNumberGlow}
                      onChange={(e) => updateTournamentInfo({ slotNumberGlow: e.target.checked })}
                      className="mr-2"
                    />
                    <label htmlFor="slotNumberGlow">Enable glow effect</label>
                  </div>
                  
                  {tournamentInfo.slotNumberGlow && (
                    <div>
                      <label className="block text-sm mb-2">Glow Color</label>
                      <input
                        type="color"
                        value={tournamentInfo.slotNumberGlowColor}
                        onChange={(e) => updateTournamentInfo({ slotNumberGlowColor: e.target.value })}
                        className="w-full h-10 rounded-md cursor-pointer"
                      />
                    </div>
                  )}
